...
namespace WoWPacketViewer.Parsers
{
    ...
    internal class AuraUpdateParser : Parser
    {
        ...
        public override string Parse()
        {
            ...
            {
                AppendFormatLine("Slot: {0}", gr.ReadByte());

                var spellId = gr.ReadUInt32();
                AppendFormatLine("Spell: {0}", spellId);
                ...
                if (spellId > 0)
                {
                    ...
                    AppendFormatLine("Charges: {0}", gr.ReadByte());
                    ...
                    {
                        AppendFormatLine("Full duration: {0}", gr.ReadUInt32());

                        AppendFormatLine("Rem. duration: {0}", gr.ReadUInt32());
                    }
                }
                AppendLine();
            }
